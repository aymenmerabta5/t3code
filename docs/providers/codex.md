...
This guide is for people who want to use more than one Codex account in GhostForge.
...
In GhostForge Settings, name it something obvious:
...
In GhostForge Settings, add another Codex provider:
...
GhostForge shows the authenticated email for providers that report one. Emails are blurred by default;
...
If you add a third Codex provider with a completely different `CODEX_HOME path`, GhostForge treats it
