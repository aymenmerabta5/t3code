  ...
  embeds: [
    {
      ...
      description:
        options.target === "prerelease"
          ? "A new GhostForge prerelease is available for nightly testers."
          : "A new GhostForge latest release is available.",
...
).pipe(Command.withDescription("Post a GhostForge release announcement to Discord."));
