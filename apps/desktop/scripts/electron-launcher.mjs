// This file mostly exists because we want dev mode to say "GhostForge (Dev)" instead of "electron"
...
const APP_DISPLAY_NAME = isDevelopment ? "GhostForge (Dev)" : "GhostForge (Alpha)";
const APP_BUNDLE_ID = isDevelopment ? "com.ghostforge.app.dev" : "com.ghostforge.app";
