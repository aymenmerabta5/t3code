...
>()("ghostforge/desktop/Environment") {}

const APP_BASE_NAME = "GhostForge";
...
const makeDesktopEnvironment = Effect.fn("desktop.environment.make")(function* (
  ...
  const baseDir = Option.getOrElse(config.ghostforgeHome, () =>
    path.join(homeDirectory, ".ghostforge"),
  );
  ...
  const userDataDirName = isDevelopment ? "ghostforge-dev" : "ghostforge";
  const legacyUserDataDirName = isDevelopment ? "GhostForge (Dev)" : "GhostForge (Alpha)";
  ...
  return DesktopEnvironment.of({
    ...
    branding,
    displayName,
    appUserModelId: isDevelopment ? "com.ghostforge.app.dev" : "com.ghostforge.app",
    linuxDesktopEntryName: isDevelopment ? "ghostforge-dev.desktop" : "ghostforge.desktop",
    linuxWmClass: isDevelopment ? "ghostforge-dev" : "ghostforge",
    userDataDirName,
