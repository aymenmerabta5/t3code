import type { DesktopSshPasswordPromptRequest } from "@ghostforge/contracts";
import { DesktopSshPasswordPromptResolutionInputSchema } from "@ghostforge/contracts";
import type { SshPasswordRequest } from "@ghostforge/ssh/auth";
...
const WINDOW_UNAVAILABLE_MESSAGE = "GhostForge window is not available for SSH authentication.";
...
>()("ghostforge/desktop/SshPasswordPrompts") {}
