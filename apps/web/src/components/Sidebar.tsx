...
function formatProjectMemberActionLabel(
  ...
  return member.environmentLabel ? `${member.environmentLabel} â€” ${member.cwd}` : member.cwd;
}
      ...
      void (async () => {
        ...
        const clicked = await api.contextMenu.show(
          [
            ...
            buildTargetedItem("grouping", "Project groupingâ€¦"),
...
function GhostForgeWordmark() {
  return (
    <span className="flex items-baseline text-sm font-semibold tracking-tight">
