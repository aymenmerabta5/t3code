import type { EnvironmentId, ServerConfig } from "@ghostforge/contracts";
...
export const VERSION_MISMATCH_DISMISSALS_STORAGE_KEY = "ghostforge:version-mismatch-dismissals:v1";
...
export function resolveVersionMismatch(
  ...
  return {
    ...
    hint: "Version mismatch. Try syncing the client and server to the same GhostForge version.",
  };
}
