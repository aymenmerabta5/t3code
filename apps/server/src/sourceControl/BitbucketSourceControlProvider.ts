...
import { SourceControlProviderError, type ChangeRequest } from "@ghostforge/contracts";
...
export const makeDiscovery = Effect.fn("makeBitbucketSourceControlProviderDiscovery")(function* () {
  ...
  return {
    ...
    label: "Bitbucket",
    installHint:
      "Set GHOSTFORGE_BITBUCKET_EMAIL and GHOSTFORGE_BITBUCKET_API_TOKEN on the server (use a Bitbucket API token with pull request and repository scopes).",
