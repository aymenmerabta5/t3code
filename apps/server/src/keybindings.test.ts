import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@ghostforge/contracts";
...
import { KeybindingsConfigError } from "@ghostforge/contracts";
    ...
    Layer.provideMerge(
      Layer.fresh(
        ServerConfig.layerTest(process.cwd(), {
          prefix: "ghostforge-keybindings-test-",
        }),
      ),
    ),
  );
