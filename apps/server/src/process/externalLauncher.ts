...
import { isCommandAvailable, type CommandAvailabilityOptions } from "@ghostforge/shared/shell";
...
export { isCommandAvailable } from "@ghostforge/shared/shell";
...
export class ExternalLauncher extends Context.Service<ExternalLauncher, ExternalLauncherShape>()(
  "ghostforge/process/ExternalLauncher",
) {}
