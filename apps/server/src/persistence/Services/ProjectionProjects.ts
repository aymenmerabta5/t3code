 ...
 */
import { IsoDateTime, ModelSelection, ProjectId, ProjectScript } from "@ghostforge/contracts";
...
>()("ghostforge/persistence/Services/ProjectionProjects/ProjectionProjectRepository") {}
