...
import type { ChatAttachment, ModelSelection, ProviderInstanceId } from "@ghostforge/contracts";
...
export type TextGenerationProvider = "codex" | "claudeAgent" | "cursor" | "opencode" | "ghostcode";
...
export class TextGeneration extends Context.Service<TextGeneration, TextGenerationShape>()(
  "ghostforge/text-generation/TextGeneration",
) {}
